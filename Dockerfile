...
CMD ["-m", "gunicorn", "-k", "uvicorn.workers.UvicornWorker", "--logger-class", "datastore_api.config.logging.gunicorn.CustomLogger", "datastore_api.main:app", "--preload", "--workers", "2", "--bind", "0.0.0.0:8000"] 
